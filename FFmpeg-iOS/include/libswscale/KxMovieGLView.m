...
- (void)updateVertices
{
    //2016 01 18 hgc start
    const BOOL fit      = (self.contentMode == UIViewContentModeScaleAspectFit);
//    const BOOL fit      = (self.contentMode == UIViewContentModeScaleToFill);
    //2016 01 18 hgc end
...
//2016 01 18 hgc end
    ...
    //for test
    NSLog(@"test width == %f",width);
    NSLog(@"test width == %f",height);
    NSLog(@"test width == %f",dH);
    NSLog(@"test width == %f",dW);
    NSLog(@"test width == %f",dd);
    NSLog(@"test width == %f",h);
    NSLog(@"test width == %f",w);
    //for test
